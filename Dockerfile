...
RUN apt-get update && apt-get install -y lsb-release software-properties-common apt-transport-https git zip unzip tmux net-tools dnsutils netcat whois gpg
